...
#define STRING_CONFIG_H_AUTHOR "(3Diwell, FlyingbearGhost5)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3DiWell Markforged FBGhost 5"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 692 }
